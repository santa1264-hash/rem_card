...
BASE_MEDICAL_TOKENS: dict[str, Any] = {
    ...
    "medical.balance.positive": "#6c757d",
...
LIGHT_TOKENS: dict[str, Any] = {
    ...
    "state.info": "#7f8c8d",
    "button.neutral.bg": "#e9ecef",
    "button.neutral.text": "#2c3e50",
    "button.neutral.border": "#bdc3c7",
    "button.neutral.hover": "#d8dde2",
    "button.neutral.pressed": "#bdc3c7",
    "button.accent.bg": "#e9ecef",
    "button.accent.text": "#2c3e50",
    "button.accent.hover": "#d8dde2",
    "button.success.bg": "#e9ecef",
    "button.success.text": "#2c3e50",
    "button.success.hover": "#d8dde2",
    ...
    "chart.axis": "#495057",
    "chart.text": "#2c3e50",
    "chart.palette.1": "#6c757d",
    "chart.palette.2": "#28a745",
    "chart.palette.3": "#e74c3c",
    "chart.palette.4": "#f39c12",
    "chart.palette.5": "#7f8c8d",
    "chart.palette.6": "#5c6770",
