...
class Sector7bal_a(BaseSectorWidget):
    def __init__(self, parent=None):
        super().__init__("7bal_a", parent)
    ...
    def setup_ui(self):
        ...
        self.main_container.setObjectName("sector_7bal_a_main_container")
        self.main_layout_v = QVBoxLayout(self.main_container)
        self.main_layout_v.setContentsMargins(1, 1, 0, 5) # Увеличен на 1px
        self.main_layout_v.setSpacing(0)
        
        # 1. Шапка
        self.header_lbl = QLabel("Сектор 7")
        ...
        # Сюда будет добавляться контент
        
        self.main_layout_v.addWidget(self.data_area, 1)

        # Применяем QSS стили
        self.main_container.setStyleSheet("""
            QWidget#sector_7bal_a_main_container {
