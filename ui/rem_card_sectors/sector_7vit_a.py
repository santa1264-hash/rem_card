...
class Sector7vit_a(BaseSectorWidget):
    def __init__(self, parent=None):
        super().__init__("7vit_a", parent)
    ...
    def setup_ui(self):
        ...
        self.main_container.setObjectName("sector_7vit_a_main_container")
        ...
        self.main_container.setStyleSheet("""
            QWidget#sector_7vit_a_main_container {
