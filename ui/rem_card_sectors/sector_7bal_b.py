...
class Sector7bal_b(BaseSectorWidget):
    def __init__(self, parent=None):
        super().__init__("7bal_b", parent)
    ...
    def setup_ui(self):
        ...
        self.main_container.setObjectName("sector_7bal_b_main_container")
        ...
        self.main_container.setStyleSheet("""
            QWidget#sector_7bal_b_main_container {
