...
REMOTE_CHANGED_AUTHORITATIVE_MESSAGE = (
    ...
    "Будет выполнено legacy emergency-authoritative объединение: локальная аварийная медицинская БД "
    "заменит сетевую медицинскую БД после резервных копий и проверок.\n"
    "Этот файловый fallback не используется в обычном автоматическом сценарии. Сетевая БД настроек заменяться не будет."
)
