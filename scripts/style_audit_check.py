...
LEGACY_BASELINE_COUNTS: dict[Path, dict[str, int]] = {
    ...
    Path("ui/analytics/graphs_dialog.py"): {"qss": 13},
    Path("ui/analytics/report_dialog.py"): {"qss": 10},
    Path("ui/analytics/statistics_dialog.py"): {"qss": 14},
    ...
    Path("ui/nurse_view/components/nurse_sector8_panel.py"): {"qss": 6},
    ...
    Path("ui/rem_card_sectors/s_print/death_outcome.py"): {"hex": 1},
    ...
    Path("ui/shared/custom_message_box.py"): {"hex": 6, "qss": 2},
    Path("ui/shared/custom_title_bar.py"): {"hex": 1, "qss": 3},
    Path("ui/shared/hybrid_shift_time_picker.py"): {"hex": 18, "qss": 1},
    Path("ui/shared/minigames/arcade_leaderboard_dialog.py"): {"qss": 1},
    Path("ui/shared/minigames/arcade_widgets.py"): {"hex": 43, "qss": 1},
    Path("ui/shared/minigames/bonus_dialog.py"): {"qss": 3},
    Path("ui/shared/minigames/game_select_page.py"): {"qss": 1},
    Path("ui/shared/minigames/leaderboard_dialog.py"): {"qss": 1},
    Path("ui/shared/minigames/snake_widget.py"): {"hex": 8, "qss": 3},
    Path("ui/shared/minigames/user_select_page.py"): {"qss": 2},
    Path("ui/shared/navigation_widgets.py"): {"qss": 5},
    Path("ui/shared/patient_archive_dialog.py"): {"hex": 11, "qss": 3},
