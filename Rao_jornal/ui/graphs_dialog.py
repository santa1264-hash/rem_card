...
from rem_card.Rao_jornal.ui.graphs_generators_1 import generate_g1_g5, generate_g6_g13, generate_g14_g18, generate_g19_g22
from rem_card.Rao_jornal.ui.graphs_generators_2 import generate_g23_g30, generate_g31_g35, generate_g36_g40, generate_g41_g45
from rem_card.Rao_jornal.ui.graphs_generators_3 import generate_g46_g50, generate_g51_g55, generate_g56_g60, generate_g61_g65
...
class GraphsDialog(QDialog):
    ...
    def _init_ui(self):
        ...
        self.title_label.setStyleSheet(f"color: #4a4a3a; font-size: 13px; font-weight: 800; letter-spacing: 1px; background: transparent;")
    ...
    def _generate_graphs(self, save_pdf=False):
        if not pd or not plt:
            ...
            CustomMessageBox.show_info(self, "Ошибка", "Библиотеки pandas или matplotlib не установлены.")
            return ""
        ...
        if not selected:
            from rem_card.Rao_jornal.ui.custom_dialogs import CustomMessageBox
            CustomMessageBox.show_info(self, "Внимание", "Выберите хотя бы один график для формирования.")
            return ""
        ...
        import tempfile
        import os
        from rem_card.Rao_jornal.config.settings import BASE_DIR
        ...
        try:
            ...
            if save_pdf:
                ...
                from rem_card.Rao_jornal.ui.custom_dialogs import CustomMessageBox
                CustomMessageBox.show_info(self, "Успех", f"Графики успешно сохранены:\n{filename}")
                return html_content

        except Exception as e:
            from rem_card.Rao_jornal.ui.custom_dialogs import CustomMessageBox
            CustomMessageBox.show_info(self, "Ошибка", f"Ошибка при формировании графиков:\n{str(e)}")
            import traceback
            traceback.print_exc()
            return ""
