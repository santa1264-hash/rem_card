...
class SyncCoordinator:
    ...
    ENTITY_SCOPES = {
        ...
        "drug_catalog": {"orders", "settings"},
        "drugs": {"orders", "settings"},
        "drug_groups": {"orders", "settings"},
        "dosage_forms": {"orders", "settings"},
        "administration_routes": {"orders", "settings"},
        "solvents": {"orders", "settings"},
        "order_templates": {"orders", "settings"},
        "lab_analysis": {"lab_orders", "settings"},
        "lab_analysis_templates": {"lab_orders", "settings"},
        "lab_materials": {"lab_orders", "settings"},
        "doctors": {"print", "settings"},
        "display_settings": {"display", "settings"},
        "background_settings": {"display", "settings"},
        "ui_backgrounds": {"display", "settings"},
        "style_settings": {"display", "settings"},
        "print_settings": {"print", "settings"},
        "print_templates": {"print", "settings"},
        "app_settings": {"display", "print", "settings"},
    ...
    def classify(cls, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        result["sync_actions"] = {
            ...
            "settings_refresh": bool("settings" in scopes),
            "display_refresh": bool("display" in scopes),
            "print_refresh": bool("print" in scopes),
        }
        return result
