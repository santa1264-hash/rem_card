...
Изображения ниже - реальные скриншоты из программы. Они сняты с текущего UI на временной демо-базе с тестовыми данными, поэтому не содержат реальных пациентов, диагнозов, назначений или медицинских записей.

![Реальный экран карты пациента](docs/assets/readme/remcard-real-screenshot.png)

![Реальный экран оперблока](docs/assets/readme/operblock-real-screenshot.png)
