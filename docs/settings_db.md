...
- настройки оперблока: бригада, виды пособия, быстрые кнопки/назначения, пресеты препаратов, пути введения и иконки;
- шаблоны питания;
...
Если врач в dev добавил фон, препарат, группу, шаблон, материал анализа, настройки печати/отображения или настройки оперблока, эти строки попадают в snapshot при компиляции и затем upsert-ятся в сетевую `remcard_settings.db`.
